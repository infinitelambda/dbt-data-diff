{% macro create__check_schema() -%}
  {{ return(adapter.dispatch('create__check_schema')()) }}
{%- endmacro %}

{% macro default__create__check_schema() %}
    ...
    {% set query -%}
        ...
        create or replace procedure {{ namespace }}.check_schema(p_batch varchar, p_diff_run_id varchar)
        returns varchar
        language sql
        as
        $$
            ...
            begin
                ...
                open c1 using(:run_timestamp, :p_batch, :p_diff_run_id, :p_batch);
                    ...
                    values (sysdate(), null, :sql_statement, :run_timestamp, 'schema', :p_diff_run_id);
